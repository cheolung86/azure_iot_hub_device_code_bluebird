...
# The device "RT101" that is getting implemented using the above interfaces.
# This id can change according to the company the user is from
# and the name user wants to call this Plug and Play device
model_id = "dtmi:com:bluebird:RT101;1"

#####################################################
# GLOBAL RT101 VARIABLES
cur_battery = None
...
async def send_telemetry_from_RT101(device_client, telemetry_msg):
...
async def main():
    ...
    async def send_telemetry():
        ...
        while True:
            ...
            await send_telemetry_from_RT101(device_client, battery_msg1)
